...
pub use imu_core::{AccelCalibration, GyroCalibration, ImuCalibration, ImuSample};
...
pub mod spec {
    ...
    pub struct SixFaceAccelReport {
        ...
        pub calibration: Option<imu_core::AccelCalibration>,
    ...
    pub fn analyze_sixface_accel(
        ...
        let calibration =
            (overall_status == VerdictStatus::Pass).then(|| imu_core::AccelCalibration {
                offset_g: [
